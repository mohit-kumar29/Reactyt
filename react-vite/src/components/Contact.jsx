...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "92445543-4e6a-48a3-ba5d-f48a962040f5");
  ...
  return (
    <div className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
         ...
         <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
            ...
            <button className='py-3 px-12 bg-black text-white rounded hover:text-gray-300'>{result ? result : "Send Message"}</button>
         </form>
    </div>
  )
}
